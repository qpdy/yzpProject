...
- [Vue 2 vs Vue 3 响应式原理差异](#5-vue-2-vs-vue-3-响应式原理差异)
- [$nextTick的作用是什么？](#6-nexttick的作用是什么)
- [scoped原理是什么？](#7-scoped原理是什么)
- [Vue中如何做样式穿透？](#8-vue中如何做样式穿透)
- [Vue组件间传值通讯有哪些方式？](#9-vue组件间传值通讯有哪些方式)
- [computed、watch有什么区别？](#10-computedwatch有什么区别)
- [props和data优先级谁高？](#11-props和data优先级谁高)
- [Vuex有哪些属性？](#12-vuex有哪些属性)
- [Vuex是单向数据流还是双向数据流？](#13-vuex是单向数据流还是双向数据流)
- [Vuex中的mutations和actions区别是什么？](#14-vuex中的mutations和actions区别是什么)
- [Vuex如何做持久化存储？](#15-vuex如何做持久化存储)
- [Vue设置代理的方式有哪些？](#16-vue设置代理的方式有哪些)
- [Vue项目打包上线的流程是怎样的？](#17-vue项目打包上线的流程是怎样的)
- [Vue路由模式有哪些？](#18-vue路由模式有哪些)
- [SPA以及SPA有什么优缺点？](#19-spa以及spa有什么优缺点)
- [Vue路径传值有哪些方式？](#20-vue路径传值有哪些方式)
- [vue router路由导航守卫有哪些类型？](#21-vue-router路由导航守卫有哪些类型)
- [Vue动态路由是什么？](#22-vue动态路由是什么)
- [v-model双向绑定原理是什么？](#23-v-model双向绑定原理是什么)
- [MVVM是什么？](#24-mvvm是什么)
- [vue常见修饰符有哪些？](#25-vue常见修饰符有哪些)
- [VUE中常见的指令有哪些？](#26-vue中常见的指令有哪些)
- [对vue指令的理解是什么？](#27-对vue指令的理解是什么)
- [如何封装vue自定义指令？](#28-如何封装vue自定义指令)
- [父子组件嵌套下的生命周期执行顺序是怎样的？](#29-父子组件嵌套下的生命周期执行顺序是怎样的)
- [如何获取事件对象？](#30-如何获取事件对象)
- [v-for中的key值作用是什么？](#31-v-for中的key值作用是什么)
- [Proxy相比defineProperty的优势在哪里？](#32-proxy相比defineproperty的优势在哪里)
- [vue-router动态路由和静态路由有什么区别？](#33-vue-router动态路由和静态路由有什么区别)
- [为什么data是一个函数？](#34-为什么data是一个函数)
- [Vue理解是什么？](#35-vue理解是什么)
- [vuex的理解是什么？](#36-vuex的理解是什么)
- [Vue项目中打包优化有哪些方式？](#37-vue项目中打包优化有哪些方式)
- [Vue实现首屏优化有哪些方法？](#38-vue实现首屏优化有哪些方法)
- [减少页面加载时间优化有哪些方法？](#39-减少页面加载时间优化有哪些方法)
- [$route和$router的区别是什么？](#40-route和router的区别是什么)
- [Vue的优点有哪些？](#41-vue的优点有哪些)
- [Vue 3 Composition API深入理解](#42-vue-3-composition-api深入理解)
- [Vue 3性能优化最佳实践](#43-vue-3性能优化最佳实践)
- [Vue 3中的Teleport和Suspense组件使用](#44-vue-3中的teleport和suspense组件使用)
- [Vue 3中watch和watchEffect的区别](#45-vue-3中watch和watcheffect的区别)
- [Vue 3中的provide/inject使用](#46-vue-3中的provideinject使用)
- [Vue 3中的异步组件和Suspense配合使用](#47-vue-3中的异步组件和suspense配合使用)
- [Vue 3中的自定义Hooks开发](#48-vue-3中的自定义hooks开发)
- [Vue 3中的响应式API深入解析](#49-vue-3中的响应式api深入解析)
- [Vue 3中的生命周期钩子详解](#50-vue-3中的生命周期钩子详解)
- [Vue 3中的TypeScript支持和类型定义](#51-vue-3中的typescript支持和类型定义)
- [sync修饰符是什么？](#52-sync修饰符是什么)
- [Vue2和Vue3的区别有哪些？](#53-vue2和vue3的区别有哪些)
- [ref和reactive的区别是什么？](#54-ref和reactive的区别是什么)
- [解决Vue页面刷新，数据丢失的方法有哪些？](#55-解决vue页面刷新数据丢失的方法有哪些)
- [单页面应用的优点、缺点？与多页面的比较](#56-单页面应用的优点缺点与多页面的比较)
- [路由加载有哪些方式？](#57-路由加载有哪些方式)
- [Vue响应式原理是什么？](#58-vue响应式原理是什么)
- [Vue改变数据后，视图怎么更新的？](#59-vue改变数据后视图怎么更新的)
- [Vue的v-model的原理是什么？](#60-vue的v-model的原理是什么)
- [Vue插槽（Slot）是什么？有哪些类型？](#61-vue插槽slot是什么有哪些类型)
- [什么是虚拟DOM？它的作用是什么？](#62-什么是虚拟dom它的作用是什么)
- [Vue的Diff算法原理是什么？](#63-vue的diff算法原理是什么)
- [Vue 2 vs Vue 3 核心差异对比](#64-vue-2-vs-vue-3-核心差异对比)
- [数据驱动视图原理](#65-数据驱动视图原理)
- [Nuxt 3 与 SSR 服务端渲染](#66-nuxt-3-与-ssr-服务端渲染)
- [Vue 3 新特性补充](#67-vue-3-新特性补充)
- [Pinia 和 Vuex 有什么区别？](#68-pinia-和-vuex-有什么区别)
- [什么是 Vue 3 的 `<script setup>`？](#69-什么是-vue-3-的-script-setup)
