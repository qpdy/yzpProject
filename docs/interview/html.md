...
## 目录
- [1. HTML5有哪些新特性？](#1-html5有哪些新特性)
- [2. title与h1标签、b与strong标签、i与em标签有什么区别？](#2-title与h1标签b与strong标签i与em标签有什么区别)
- [3. img标签的title和alt属性有什么区别？](#3-img标签的title和alt属性有什么区别)
- [4. 什么是语义化标签？使用语义化标签有什么好处？](#4-什么是语义化标签使用语义化标签有什么好处)
- [5. 为什么img标签的src属性不能为空？应该如何正确处理？](#5-为什么img标签的src属性不能为空应该如何正确处理)
- [6. DOCTYPE有什么作用？](#6-doctype有什么作用)
- [7. 行内元素、块级元素和空元素分别有哪些？](#7-行内元素块级元素和空元素分别有哪些)
- [8. iframe有哪些优缺点？](#8-iframe有哪些优缺点)
- [9. meta标签有哪些常用的属性和作用？](#9-meta标签有哪些常用的属性和作用)
- [10. data-* 自定义数据属性](#10-data--自定义数据属性)
